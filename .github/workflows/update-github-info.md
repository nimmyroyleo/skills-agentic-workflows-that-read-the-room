...
3. Use `web-fetch` to read all official sources:
   - https://github.blog/latest/
   - https://github.blog/changelog/
   - https://awesome-copilot.github.com/workflows/
4. Select only useful, recent updates that fit Mona's practical developer-focused editorial angle. Keep summaries short and practical, and mention the source for every blog, changelog, or Awesome Copilot workflow item.
